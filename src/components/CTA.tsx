export function CTA() {
  return <section className="py-16 bg-gradient-to-r from-[#C3B34C] to-[#C35919] text-white">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a href="#contact" className="bg-[#FAB111] hover:bg-yellow-600 text-gray-900 font-semibold px-8 py-4 rounded-md transition-colors text-lg">
            Get Your Free Quote
          </a>
